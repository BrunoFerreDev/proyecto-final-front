...
const tipo = ref(1);
const totalJugadores = ref(1);
const totalClubes = ref(1);
onMounted(() => {
  fetchJugadores();
  fetchClubes();
});
...
const fetchJugadores = async () => {
  try {
    const { data } = await axios.get("http://localhost:8080/api/personas", {
      params: {
        tipo: 1
      },
      headers: {
          ...
          <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div
              ...
              <div class="flex items-end gap-2 mt-2">
                ...
                <p class="text-[#078816] text-sm font-bold mb-1 bg-[#078816]/10 px-2 py-0.5 rounded-full">
                  +2%
                </p>
              </div>
            </div>
                ...
                <div class="overflow-x-auto">
                  <table class="w-full min-w-175">
                    <thead class="bg-[#f8f8f5] border-b">
                      <tr>
                        <th class="px-6 py-4 text-left text-black text-sm font-semibold uppercase tracking-wider w-24">
                          Fecha
                        </th>
                        ...
                        <th class="px-6 py-4 text-right text-black text-sm font-semibold uppercase tracking-wider w-32">
                          Detalles
                        </th>
                      </tr>
                    </thead>
                        ...
                        <td class="px-6 py-4">
                          <div class="flex items-center justify-center gap-4">
                            <div class="flex items-center gap-3 justify-end w-[40%]">
                              <span class="text-[#1c1c0d] font-bold text-base">Leones FC</span>
                              <div class="size-10 rounded-full bg-gray-100 bg-center bg-cover border border-gray-200"
                                style="
                                  background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuCPCdho_hO7ZmbqTyw73T0ndNCoT3Md4GGdASf1Szhv044k_l7vYBJEWYQEDfcb8eu-YDtBJraVyp_QLKTu0ddnicq5fq5oS_Q_TchsjWb3DzWO7mIpGhtHAjcezFGu4s3GrYAsTrDuAZEi3_Q7CIj7y6DebnjCRm5a44-YqkpmAo9-vcqfz8yfI-07-xA__hgUlQBcCVRHTnNwOk3RQrg6WbZxNC1HVqxfnn--uSCmHn5jskfOxYNK8GbtE-NlDesqJwmEPIdfK5g');
                                "></div>
                            </div>
                            ...
                            <div class="flex items-center gap-3 w-[40%]">
                              <div class="size-10 rounded-full bg-gray-100 bg-center bg-cover border border-gray-200"
                                style="
                                  background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuDiSmQcOSg7ocnqxLlASBaJXndbbs49HSUTPt8WEiPCs2Fvu1R4aQGNJtNwW_BA3Tf5suOZoqAXEgriJEUY0VXayE64Uuw7aZy9pcNEYe-V-T7JwFUUdcTAFtqzoKqL-UPU0b6oR1tXSM8cS-ML9MlZSw0FtO_EerKckUCqzSCcD2h2cVgdyM7R0ct3iSGdKv0pvBfonowcmOjVGsmhroJP9xtezmNbLIncyjyjtsDtvrpPjtNoCzRIjLae0MWvz4DsaS3GAmSxIVs');
                                "></div>
                              <span class="text-[#1c1c0d] font-bold text-base">Tigres</span>
                            </div>
                          </div>
                        </td>
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                  ...
                  <button @click.prevent="navigateTo('/nuevo-partido')"
                    ...
                    <span class="text-sm font-bold text-[#1c1c0d] text-center">Programar Partido</span>
                  </button>
                </div>
              </div>
              <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                  ...
                  <span class="text-[#d32f2f] text-xs font-bold bg-[#d32f2f]/10 px-2 py-1 rounded-full">Jornada
                    12</span>
                </div>
                <div class="flex flex-col gap-3 rounded-3xl bg-white p-4 border border-gray-50 shadow-sm min-h-75">
                  <div class="flex items-start gap-4 p-3 bg-red-50 rounded-2xl border border-red-100">
                    <div
                    ...
                    <div class="flex flex-col">
                      <div class="flex justify-between items-start">
                        <p class="text-sm text-[#1c1c0d] font-bold">
                          Carlos Ruiz
                        </p>
                        <span class="text-[10px] font-bold text-red-600 bg-red-100 px-2 py-0.5 rounded-full">Roja
                          Directa</span>
                      </div>
                      <p class="text-xs text-black mb-1">
                        Tigres (vs Leones FC)
                      </p>
                      <p class="text-xs text-[#1c1c0d] italic">
                        "Agresión a un contrario sin disputa del balón"
                      </p>
                    </div>
                  </div>
