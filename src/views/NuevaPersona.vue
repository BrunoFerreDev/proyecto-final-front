...
const nuevaPersona = async () => {
  try {
    ...
    if (response && response.data) {
      ...
      await axios.put(`http://localhost:8080/api/personas/${idGenerado}`, {
  ...
  <main class="w-full max-w-5xl mx-auto px-6 py-8 md:py-12" v-show="false">
    ...
    >
      <div class="flex flex-col gap-2">
        <div
          class="flex items-center gap-2 text--white text-sm font-medium mb-1"
        >
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div class="lg:col-span-4 flex flex-col gap-6">
        ...
        <div
          class="bg-surface-light p-6 rounded-lg border shadow-sm flex flex-col items-center text-center"
        >
        ...
        <div class="bg-surface-light p-6 rounded-lg border shadow-sm">
          ...
          <div class="flex flex-col gap-2">
            ...
            >
              ...
              <div
                class="absolute right-4 hidden peer-checked:block text-[#1f44f9]"
              >
                <IconCheck />
              </div>
            </label>
      ...
      <div class="lg:col-span-8">
        <form class="flex flex-col gap-6" @submit.prevent="nuevaPersona">
          ...
          <div class="bg-surface-light p-6 md:p-8 rounded-lg border shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <label class="flex flex-col gap-2">
                <span class="text-sm font-semibold text-[#1c1c0d]"
              ...
              <label class="flex flex-col gap-2">
                <span class="text-sm font-semibold text--[#1c1c0d]"
                  >Apellido <span class="text-red-500">*</span></span
                >
                <input
                  ...
                  type="text"
                  required
                  v-model="personaNueva.apellido"
                />
              </label>
              <label class="flex flex-col gap-2">
                <span class="text-sm font-semibold text--[#1c1c0d]"
                  >Documento (DNI/Pasaporte)</span
                >
                <input
                  class="w-full rounded-xl border focus:border-transparent py-3 px-4 text-[#1c1c0d] placeholder-text-white/60 transition-shadow"
                  placeholder="12.345.678"
                  type="text"
                  v-model="personaNueva.dni"
                  required
                />
              </label>
              <label class="flex flex-col gap-2">
                ...
                <div class="relative">
                  <input
                    ...
                    type="date"
                    v-model="personaNueva.fechaNacimiento"
                    required
                  />
                </div>
              </label>
          ...
          <div
            class="bg-surface-light p-6 md:p-8 rounded-lg border shadow-sm relative overflow-hidden"
            v-if="
          ...
          >
            ...
            <div class="flex items-center justify-between mb-6 border-b pb-4">
              ...
              <span
                class="text-xs font-medium px-2 py-1 bg-[#1f44f9]/20 text--[#1c1c0d] rounded-md"
                >Perfil Jugador</span
              >
            </div>
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div class="md:col-span-12">
                <label class="flex flex-col gap-2">
                  <span class="text-sm font-semibold text--[#1c1c0d]"
                    >Notas Médicas / Observaciones</span
                  >
                  <textarea
